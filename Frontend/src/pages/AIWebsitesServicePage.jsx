          ...
          <div className="lg:col-span-5">
            <div className="sticky top-28 space-y-4">
              ...
              <div className="bg-slate-900 border border-white/8 rounded-3xl overflow-hidden shadow-2xl shadow-black/40">
                ...
                <div className="bg-gradient-to-br from-violet-950/70 to-slate-900 px-7 py-7 border-b border-white/8">
                  <p className="text-[0.68rem] font-black text-violet-400/80 uppercase tracking-widest mb-2">
                    Starting at
                  </p>
                  <div className="flex items-baseline gap-2 mb-2">
                    <span className="text-[3.2rem] font-black text-white leading-none">$1,499</span>
                    <span className="text-slate-400 text-sm">one-time</span>
                  </div>
                  <p className="text-[0.75rem] text-slate-500 leading-relaxed">
                    Final price is confirmed after the free scoping call based on page count,
                    complexity, and integrations required.
                  </p>
                </div>
                ...
                <div className="px-7 py-6">
                  {!user ? (
                    ...
                    <form onSubmit={handleConfirm} noValidate className="space-y-5">
                      ...
                      <button
                        type="submit"
                        className="w-full bg-violet-600 hover:bg-violet-500 text-white font-black text-[0.9rem] py-3.5 rounded-xl transition-all duration-200 shadow-lg shadow-violet-600/30 hover:shadow-violet-500/40"
                      >
                        Confirm Booking →
                      </button>
